...
template <typename T>
unsigned int WeightedMatMultMapBody<T>::Hash(unsigned int modsize) const
{
...
template <>
unsigned int WeightedMatMultMapBody<BIG_COMPLEX_FLOAT>::Hash(unsigned int modsize) const
{
	/*if (modsize == HASHSETBASE)
		return hashCheck;*/
	unsigned int hvalue = 0;
...
template <>
unsigned int WeightedMatMultMapBody<fourierSemiring>::Hash(unsigned int modsize) const
{
	/*if (modsize == HASHSETBASE)
		return hashCheck;*/
	unsigned int hvalue = 0;
...
template <typename T>
unsigned int WeightedMatMultMapHandle<T>::Hash(unsigned int modsize) const
{
