...
namespace CFL_OBDD
{
	namespace HowellMatrix
	{
		...
		public:
			...
			virtual const ref_ptr<TArray<T> > GetRow(size_t r) const = 0;

			virtual const ref_ptr<SparseTArray<T> > GetConstSparseRow(size_t r) const = 0;

			virtual ref_ptr<SparseTArray<T> > GetSparseRow(size_t r) = 0;
