#ifndef WEIGHTED_CFLOBDD_TOP_NODE_COMPLEX_FLOAT_BOOST_GUARD
#define WEIGHTED_CFLOBDD_TOP_NODE_COMPLEX_FLOAT_BOOST_GUARD
...
namespace CFL_OBDD {
	...
	typedef WeightedCFLOBDDTopNodeT<BIG_COMPLEX_FLOAT, std::multiplies<BIG_COMPLEX_FLOAT>> WeightedCFLOBDDComplexFloatBoostTopNode;

	// CFLOBDDTopNode-creation operations --------------------------------------
	extern WeightedCFLOBDDTopNodeComplexFloatBoostRefPtr MkTrueComplexFloatMulTop();                    // Representation of \x.true
