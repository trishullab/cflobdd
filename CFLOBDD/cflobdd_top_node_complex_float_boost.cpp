...
#include "cflobdd_top_node_complex_float_boost.h"
...
namespace CFL_OBDD {
	...
	CFLOBDDTopNodeComplexFloatBoostRefPtr MkTrueComplexFloatTop()
	{
		...
		m.Canonicalize();
		v = new CFLOBDDComplexFloatBoostTopNode(CFLOBDDNodeHandle::NoDistinctionNode[CFLOBDD_MAX_LEVEL], m);
		return v;
	}
