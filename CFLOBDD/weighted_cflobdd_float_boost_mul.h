#ifndef WEIGHTED_CFLOBDD_FLOAT_BOOST_MUL_GUARD
#define WEIGHTED_CFLOBDD_FLOAT_BOOST_MUL_GUARD
...
namespace CFL_OBDD {
	...
	typedef WEIGHTED_CFLOBDD_T<BIG_FLOAT, std::multiplies<BIG_FLOAT>> WEIGHTED_CFLOBDD_FLOAT_BOOST;
