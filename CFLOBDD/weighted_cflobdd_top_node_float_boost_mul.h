#ifndef WEIGHTED_CFLOBDD_TOP_NODE_FLOAT_BOOST_GUARD
#define WEIGHTED_CFLOBDD_TOP_NODE_FLOAT_BOOST_GUARD
...
namespace CFL_OBDD {
	...
	typedef WeightedCFLOBDDTopNodeT<BIG_FLOAT, std::multiplies<BIG_FLOAT>> WeightedCFLOBDDFloatBoostTopNode;

	// CFLOBDDTopNode-creation operations --------------------------------------
	extern WeightedCFLOBDDTopNodeFloatBoostRefPtr MkTrueFloatMulTop();                    // Representation of \x.true
