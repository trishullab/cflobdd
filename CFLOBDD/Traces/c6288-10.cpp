...
CFLOBDD b9 = MkProjection(coeff*10 + offset, max_level);
CFLOBDD b8 = MkProjection(coeff*11 + offset, max_level);
CFLOBDD b7 = MkProjection(coeff*12 + offset, max_level);
CFLOBDD b6 = MkProjection(coeff*13 + offset, max_level);
CFLOBDD b5 = MkProjection(coeff*14 + offset, max_level);
CFLOBDD b4 = MkProjection(coeff*15 + offset, max_level);
CFLOBDD b3 = MkProjection(coeff*16 + offset, max_level);
CFLOBDD b2 = MkProjection(coeff*17 + offset, max_level);
CFLOBDD b1 = MkProjection(coeff*18 + offset, max_level);
CFLOBDD b0 = MkProjection(coeff*19 + offset, max_level);
