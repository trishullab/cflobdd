#ifndef WEIGHTED_CFLOBDD_COMPLEX_FB_MUL_GUARD
#define WEIGHTED_CFLOBDD_COMPLEX_FB_MUL_GUARD
...
namespace CFL_OBDD {
	...
	typedef WEIGHTED_CFLOBDD_T<BIG_COMPLEX_FLOAT, std::multiplies<BIG_COMPLEX_FLOAT>> WEIGHTED_CFLOBDD_COMPLEX_FB;
