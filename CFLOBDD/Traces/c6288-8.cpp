...
// std::coutcout << "	pp0_0	 " << // std::coutendl;
...
// std::coutcout << "	pp1_1	 " << // std::coutendl;
...
// std::coutcout << "	gate1_1_4	" << // std::coutendl;
...
// std::coutcout << "	gate2_1_5	" << // std::coutendl;
...
// std::coutcout << "	gate3_1_6	" << // std::coutendl;
...
// std::coutcout << "	s4_1	" << // std::coutendl;
...
// std::coutcout << "	c5_1	" << // std::coutendl;
...
// std::coutcout << "	s7_1	" << // std::coutendl;
CFLOBDD	s7_1	= pp7_1;
...
// std::coutcout << "	gate0_2_1	" << // std::coutendl;
...
// std::coutcout << "	gate1_2_2	" << // std::coutendl;
...
// std::coutcout << "	gate2_2_3	" << // std::coutendl;
...
// std::coutcout << "	gate3_2_4	" << // std::coutendl;
...
// std::coutcout << "	gate4_2_5	" << // std::coutendl;
...
// std::coutcout << "	gate5_2_6	" << // std::coutendl;
...
// std::coutcout << "	s6_2	" << // std::coutendl;
...
// std::coutcout << "	pp7_3	 " << // std::coutendl;
...
// std::coutcout << "	gate1_3_0	" << // std::coutendl;
...
// std::coutcout << "	gate2_3_1	" << // std::coutendl;
...
// std::coutcout << "	gate3_3_2	" << // std::coutendl;
...
// std::coutcout << "	gate4_3_3	" << // std::coutendl;
...
// std::coutcout << "	gate5_3_4	" << // std::coutendl;
...
// std::coutcout << "	gate6_3_5	" << // std::coutendl;
...
// std::coutcout << "	pp5_4	 " << // std::coutendl;
...
// std::coutcout << "	sum4	" << // std::coutendl;
...
// std::coutcout << "	c1_4	" << // std::coutendl;
...
// std::coutcout << "	gate3_4_0	" << // std::coutendl;
...
// std::coutcout << "	gate4_4_1	" << // std::coutendl;
...
// std::coutcout << "	gate5_4_2	" << // std::coutendl;
...
// std::coutcout << "	gate6_4_3	" << // std::coutendl;
...
// std::coutcout << "	pp3_5	 " << // std::coutendl;
...
// std::coutcout << "	gate0_5_5	" << // std::coutendl;
...
// std::coutcout << "	gate1_5_6	" << // std::coutendl;
...
// std::coutcout << "	s2_5	" << // std::coutendl;
...
// std::coutcout << "	c3_5	" << // std::coutendl;
...
// std::coutcout << "	gate5_5_0	" << // std::coutendl;
...
// std::coutcout << "	gate6_5_1	" << // std::coutendl;
...
// std::coutcout << "	pp1_6	 " << // std::coutendl;
...
// std::coutcout << "	gate0_6_3	" << // std::coutendl;
...
// std::coutcout << "	gate1_6_4	" << // std::coutendl;
...
// std::coutcout << "	gate2_6_5	" << // std::coutendl;
...
// std::coutcout << "	gate3_6_6	" << // std::coutendl;
...
// std::coutcout << "	s4_6	" << // std::coutendl;
...
// std::coutcout << "	c5_6	" << // std::coutendl;
...
// std::coutcout << "	s7_6	" << // std::coutendl;
CFLOBDD	s7_6	= pp7_6;
...
// std::coutcout << "	gate0_7_1	" << // std::coutendl;
...
// std::coutcout << "	gate1_7_2	" << // std::coutendl;
...
// std::coutcout << "	gate2_7_3	" << // std::coutendl;
...
// std::coutcout << "	gate3_7_4	" << // std::coutendl;
...
// std::coutcout << "	gate4_7_5	" << // std::coutendl;
...
// std::coutcout << "	gate5_7_6	" << // std::coutendl;
...
// std::coutcout << "	s6_7	" << // std::coutendl;
...
// std::coutcout << "	sum8	" << // std::coutendl;
...
// std::coutcout << "	c1_8	" << // std::coutendl;
...
// std::coutcout << "	gate3_8_0	" << // std::coutendl;
...
// std::coutcout << "	gate4_8_1	" << // std::coutendl;
...
// std::coutcout << "	gate5_8_2	" << // std::coutendl;
...
// std::coutcout << "	gate6_8_3	" << // std::coutendl;
...
// std::coutcout << "CFLOBDD sizes" << // std::coutendl;
...
// // std::coutvector<CFLOBDD> sums = {sum0, sum1, sum2, sum3, sum4, sum5, sum6, sum7, sum8, sum9, sum10, sum11, sum12, sum13, sum14, sum15};
// for (int i = 0; i < sums.size(); i++) {
//   nodeCount = 0;
//   edgeCount = 0;
//   unsigned int returnEdgesCount = 0, returnEdgesObjCount = 0;
//   // std::coutcout << "sum" << i << " size -------------------------" << // std::coutendl;
//   sums[i].CountNodesAndEdges(nodeCount, edgeCount, returnEdgesCount, returnEdgesObjCount);
//   // std::coutcout << "|sum" << i << "| = " << nodeCount << ", " << edgeCount << // std::coutendl;
// }

// nodeCount = 0;
// edgeCount = 0;
// unsigned int returnEdgesCount = 0, returnEdgesObjCount = 0;
// // std::coutcout << "sum6 size -------------------------" << // std::coutendl;
// sum6.CountNodesAndEdges(nodeCount, edgeCount, returnEdgesCount, returnEdgesObjCount);
// // std::coutcout << "|sum6| = " << nodeCount << ", " << edgeCount << // std::coutendl;
...
for (int k = 15; k >= 0; k--) {
  // std::coutcout << (val[k]?1:0);
}
// std::coutcout << // std::coutendl;
// std::coutcout << a*b << // std::coutendl;
*/
}
